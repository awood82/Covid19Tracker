...
class FakeRepository : IStatsRepository {
    companion object {
        // Sample stats to use for testing
        val WORLD_STATS = RegionalStats("World", "", "5,000", "2,500", "2,000", "500")
        val USA_STATS = RegionalStats("USA", "", "1,000", "500", "400", "100")
        val GERMANY_STATS = RegionalStats("Germany", "", "100", "50", "40", "10")
        // The real server always returns worldStats first
        val SAMPLE_LIST = listOf(WORLD_STATS, USA_STATS, GERMANY_STATS)
    }

    private val regionalStats = MutableLiveData<List<RegionalStats>>()
